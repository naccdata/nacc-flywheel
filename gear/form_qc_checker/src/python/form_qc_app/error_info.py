...
def replace_nullable_with_required(rule: str, code_shema: Dict[str,
                                                               Dict]) -> bool:
    ...
    Args:
        rule: rule name
        code_shema: schema mapping validation rule -> NACC code
...
class ErrorComposer():
    ...
    def _map_error_with_qc_check_code(self,
        ...
        Args:
            field: variable name
            code_shema: schema describing validation rule->NACC code mapping
